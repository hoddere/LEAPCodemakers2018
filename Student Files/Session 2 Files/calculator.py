...
##justify(which way text leans)
txtDisplay = Entry(cal, font = ("arial", 20, "bold"), textvariable=text_Input, bd=30, insertwidth=4,
                   bg="red", justify="right").grid(columnspan=4)

##padx(how wide button is), bd(border size), fg(text colour)
...
btnequals = Button(cal, padx=16, bd=8, fg="black", font=("arial", 20, "bold"),
              text="=", command = btnEquals).grid(row = 4, column = 1)

btndivide = Button(cal, padx=16, bd=8, fg="black", font=("arial", 20, "bold"),
