...
WriteOnlyCharacteristic.prototype.onWriteRequest = function(data, offset, withoutResponse, callback) {
  ...
  PythonShell.run('print.py', { args: [response] }, function (err, results) {
	  if (err) throw err;
...
function SampleService() {
  SampleService.super_.call(this, {
    uuid: 'd104f3f2-82dd-4f10-bd47-03867c2afa5b',
    characteristics: [
...
bleno.on('stateChange', function(state) {
  ...
  if (state === 'poweredOn') {
    bleno.startAdvertising('raspberrypi', ['d104f3f2-82dd-4f10-bd47-03867c2afa5b']);
  } else {
